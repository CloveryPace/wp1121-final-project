...
function CreatePage() {
  const [data, setData] = useState([{name: "", count: "", category: "", photo: ""}]);

  const handleClick = () => {
    setData([...data, {name: "", count: "", category: "none", photo: ""}]);
  }
        ...
        {/* <div className="flex flex-row mt-12 items-center space-x-6">
          ...
          <div className="w-20">
            ...
            <label htmlFor="taste-photo">
              <input type="file" id="taste-photo" name="myfile" hidden></input>
              <div className="h-10 flex items-center justify-center border border-black rounded-md file:text-theme-green cursor-pointer">
                瀏覽
              </div>
            </label>
          </div>
          <button className="pt-5 ml-4" onClick={handleClick}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
            </svg>
          </button>
          <button className="pt-5 ml-4" onClick={() => append({taste_name: "", taste_count: NaN, taste_category: "", taste_photo: ""})}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
            </svg>
          </button>
